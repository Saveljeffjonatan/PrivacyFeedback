defmodule PrivacyFeedbackWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PrivacyFeedbackWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PrivacyFeedbackWeb.Gettext, "errors", msg, opts)
    end
  end
